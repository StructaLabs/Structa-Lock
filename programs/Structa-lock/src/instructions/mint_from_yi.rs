//! Instruction handler for [SVE_token::mint_from_yi].

use crate::*;
use anchor_spl::token::{self, TokenAccount};

/// Accounts for [SVE_token::mint_from_yi].
#[derive(Accounts)]
        ...
        token::transfer(
            CpiContext::new(
                ...
                token::Transfer {
                    ...
                    to: self.common.SVE_yi_tokens.to_account_info(),
...
impl<'info> Validate<'info> for MintFromYi<'info> {
    fn validate(&self) -> Result<()> {
        ...
        assert_keys_eq!(SVE.yi_mint, self.source_yi_tokens.mint);
        Ok(())
    }
}
